...
<div class="wrapper"  id="app" v-cloak >
  ...
  <div class="content-wrapper">
    ...
    <div id="dataOption" class="pull-right">
        <div class="btn-group">
            <button  type="button" id="adduser"  class="btn btn-danger btn-sm" style="height:25px ;width:68px;">
	 ...
	 $('#dataTable tbody').on( 'click', 'button#delRow', function () {
	   ...
	   //修改方法必须放在$datatable下 绑定button 不好用vue
	    ...
	    btn: ['修改','取消'],
     	 ...
     	 //添加方法 
	    $('#dataOption').on('click', 'button#adduser', function () {
	    $.ajax({
			type: "post" ,
