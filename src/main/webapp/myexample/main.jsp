...
<div class="wrapper"   id="app" v-cloak >
	...
	<!-- edituser -->
	<%-- <%@ include file="/WEB-INF/jsp/edituser.jsp" %> --%>
            ...
            <table id="dataTable" class="table table-striped table-bordered table-hover table-condensed" >
		    	...
		    	<thead>
		    				  <div class="pull-right" >
								        <div class="btn-group">
								            <button type="button"  class="btn btn-primary btn-sm" id="test1" style="height:25px ;width:65px;">
		    				 ...
		    				 <div class="pull-right"  >
								 <div class="btn-group">
							            <button type="button" @click="adduser" class="btn btn-primary btn-sm"  id="btn-add" style="height:25px ;width:65px;">
